...
# Create Function To Dell With time 
def play_time():
	# Checked Function To Deal With Time
	if stopped:
		return  
	#Grab Current song time 
	current_time = pygame.mixer.music.get_pos() / 1000
	# converted Song Time To Time Format
	converted_current_time = time.strftime('%M:%S', time.gmtime(current_time)) 


	# Reconstruct song with directory structure stuff
	song = playlist_box.get(ACTIVE)
	song = f'C:/c/mp3/audio/{song}.mp3'
	...
	if int(song_slider.get()) == int(song_length):
		...
		# Output new time value to slider, and th length of song
	...
	#Create Loop To Check thew Time every second
...
def add_song():
	...
	song = song.replace("C:/c/mp3/audio/","")
...
def delete_song():
	# Deleted Highlighted Song From Playlist 
	playlist_box.delete(ANCHOR)

# Create Function To Delete All Songs From Playlist
def delete_all_songs():
	# Deleted All Songs From Playlist 	
